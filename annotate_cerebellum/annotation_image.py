...
class AnnotationImage:
    ...
    def update_slice(self, voxels_to_update, key):
        ...
        :param voxels_to_update: np.ndarray list of voxels to update
        :param key: Key of the DICT_REG_NUMBERS and DICT_REG_COLORS corresponding to the new value.
        """
    ...
    def revert_slice(self, voxels_to_update):
        ...
        :param voxels_to_update: np.ndarray list of voxels to revert.
        """
        for voxel in voxels_to_update:
            slice_pos = np.s_[self.idX, self.idsY[0] + voxel[0], self.idsZ[0] + voxel[1]]
            if 0 <= voxel[0] < self.picRGB.shape[0] and \
    ...
    def change_slice(self, coronal_pos):
        ...
        :param coronal_pos: New position of the slice.
        """
