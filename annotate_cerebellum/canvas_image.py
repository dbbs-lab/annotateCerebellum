...
# Code from foobar167
# See https://stackoverflow.com/questions/41656176/tkinter-canvas-zoom-move-pan#
...
class CanvasImage:
    ...
    def smaller(self):
        ...
        while i < self.imheight:
            ...
            self.__image.close()
            self.__image = Image.fromarray(self.image_array, 'RGB')  # reopen / reset image
    ...
    def get_offsets(self):
        return (self.canvas.canvasx(0) - self.canvas.coords(self.container)[0], 
                self.canvas.canvasy(0) - self.canvas.coords(self.container)[1])
    ...
    def load_image(self):
        with warnings.catch_warnings():  # suppress DecompressionBombWarning
            ...
            self.__image = Image.fromarray(self.image_array, 'RGB')
        ...
        self.__pyramid = [self.smaller()] if self.__huge else [Image.fromarray(self.image_array, 'RGB')]
